...
namespace FoodDetailTesting
{
    ...
    public class FoodItemTests
    {
        ...
        [TestCase("abc",2,"12/12/2022", 23.23)]
        [TestCase("Ice Cream", 2, "12/10/2022", 21000.00)]
        ...
        [TestCase("abc", 2, "12/12/2021", -0.00001)]
        [TestCase("Ice Cream", 2, "12/10/2021", -10000)]
        ...
        [TestCase("abc", 2, "12/12/2020", 200)]
        [TestCase("Ice Cream", 2, "12/10/2000",22.22)]
